...
const Auth = ({isModel = false}) => {
    ...
    const handleGoogleAuth = async()=>{
        try{
            ...
            console.log("error in handleAuthGoogle" , error)
      ...
      className={`w-full  ${isModel ? 'max-w-md p-8 rounded-3xl' : 'max-w-lg p-12 rounded-[32px] '}  bg-white shadow-2xl border border-gray-200`} >
        ...
        <h1 className='text-2xl md:text-3xl font-semibold text-center leading-snug mb-4'>
            ...
            <span className='bg-green-100 text-green-600 px-3 py-1 rounded-full inline-flex items-center gap-2 '>
                <IoSparklesSharp /> AI Smart Interview
            </span>
        </h1>

        <p className='text-gray-500 text-center text-sm md:text-base leading-relaxed mb-8 '>
            Sign in to start AI-powered mock Interviews, track your progress, and unlock detailed performance insigths.
        </p>
        <motion.button 
