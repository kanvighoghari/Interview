...
const Pricing = () => {
  ...
  const handlePayment =async (plan)=>{
    try {
      ...
      const result = await api.post("/payment/order" , {planId:plan.id , amount:amount , credits:plan.credits })
  ...
  return (
    <div className='min-h-screen bg-gradient-to-r from-gray-50 to to-emerald-50 py-16 px-6'>
          ...
          className={`relative rounded-3xl p-8 transition-all duration-300 border
            ...
            `}>
              ...
              {/* default tag */}
               {
                plan.default && (
                  <div className='absolute top-6 right-6 bg-gray-200 text-gray-700 text-xs px-4 py-1 rounded-full shadow'>Free Plan</div>
                )
              }
