...
const Step3Report = ({report}) => {
  ...
  const {
   ...
   if(finalScore >=8){
    ...
    performanceText = "Needs minor improvment before interviews.";
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-10'>
